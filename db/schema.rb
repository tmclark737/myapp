...
ActiveRecord::Schema.define(version: 20141110162559) do
  ...
  create_table "ballast_codes", force: true do |t|
  ...
  create_table "ballasts", force: true do |t|
    t.integer  "ballast_code_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "ballasts", ["ballast_code_id"], name: "index_ballasts_on_ballast_code_id", using: :btree
